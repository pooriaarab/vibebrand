...
export const DIRECTIONS: BrandDirection[] = [
  {
    ...
    light: {
      ...
      secondary: "oklch(0.50 0.16 145)",
      tertiary: "oklch(0.52 0.22 320)",
    },
    dark: {
      bg: "oklch(0.15 0.012 250)",
      fg: "oklch(0.97 0.006 250)",
      muted: "oklch(0.70 0.02 250)",
      primary: "oklch(0.82 0.16 200)",
      secondary: "oklch(0.88 0.20 130)",
      tertiary: "oklch(0.72 0.20 320)",
    },
  ...
  },
  {
    ...
    light: {
      bg: "oklch(0.98 0.012 90)",
      fg: "oklch(0.20 0.02 330)",
      muted: "oklch(0.48 0.04 330)",
      primary: "oklch(0.55 0.24 350)",
      secondary: "oklch(0.62 0.18 45)",
      tertiary: "oklch(0.52 0.20 285)",
    },
    dark: {
      bg: "oklch(0.17 0.03 330)",
      fg: "oklch(0.96 0.01 330)",
      muted: "oklch(0.72 0.04 330)",
      primary: "oklch(0.70 0.26 350)",
      secondary: "oklch(0.78 0.18 45)",
      tertiary: "oklch(0.68 0.20 285)",
    },
  ...
  },
  {
    ...
    light: {
      ...
      fg: "oklch(0.20 0.015 265)",
      muted: "oklch(0.46 0.03 265)",
      primary: "oklch(0.52 0.20 275)",
      secondary: "oklch(0.54 0.20 305)",
      tertiary: "oklch(0.49 0.13 220)",
    },
    dark: {
      bg: "oklch(0.16 0.015 265)",
      fg: "oklch(0.96 0.006 265)",
      muted: "oklch(0.70 0.02 265)",
      primary: "oklch(0.66 0.19 278)",
      secondary: "oklch(0.68 0.19 305)",
      tertiary: "oklch(0.74 0.13 220)",
    },
    fonts: { display: "Inter", body: "Inter", mono: "JetBrains Mono" },
    signature:
      "fine engineering grid, glass cards, hairline node graph traced by one indigo signal",
    press: "restrained",
    radius: "soft",
  },
  {
    ...
    light: {
      ...
      fg: "oklch(0.16 0.01 30)",
      muted: "oklch(0.44 0.03 30)",
      primary: "oklch(0.53 0.20 25)",
      secondary: "oklch(0.52 0.16 250)",
      tertiary: "oklch(0.70 0.16 95)",
    },
    dark: {
      bg: "oklch(0.19 0.05 285)",
      fg: "oklch(0.96 0.02 90)",
      muted: "oklch(0.72 0.04 285)",
      primary: "oklch(0.70 0.20 25)",
      secondary: "oklch(0.72 0.16 250)",
      tertiary: "oklch(0.85 0.17 95)",
    },
    fonts: { display: "Space Grotesk", body: "Inter", mono: "JetBrains Mono" },
  ...
  },
  {
    ...
    light: {
      ...
      fg: "oklch(0.16 0 0)",
      muted: "oklch(0.42 0.006 90)",
      primary: "oklch(0.62 0.18 135)",
      secondary: "oklch(0.49 0.15 235)",
      tertiary: "oklch(0.55 0.24 350)",
    },
    dark: {
      bg: "oklch(0.14 0.008 150)",
      fg: "oklch(0.90 0.13 135)",
      muted: "oklch(0.62 0.09 140)",
      primary: "oklch(0.88 0.22 130)",
      secondary: "oklch(0.78 0.15 220)",
      tertiary: "oklch(0.72 0.24 350)",
    },
  ...
  },
  {
    ...
    light: {
      ...
      fg: "oklch(0.24 0.04 265)",
      muted: "oklch(0.48 0.05 265)",
      primary: "oklch(0.55 0.20 300)",
      secondary: "oklch(0.49 0.13 175)",
      tertiary: "oklch(0.58 0.20 340)",
    },
    dark: {
      bg: "oklch(0.17 0.03 260)",
      fg: "oklch(0.96 0.01 250)",
      muted: "oklch(0.72 0.03 260)",
      primary: "oklch(0.70 0.24 340)",
      secondary: "oklch(0.82 0.15 175)",
      tertiary: "oklch(0.72 0.20 300)",
    },
  ...
  },
  {
    ...
    light: {
      bg: "oklch(0.96 0.02 320)",
      fg: "oklch(0.22 0.06 285)",
      muted: "oklch(0.46 0.06 285)",
      primary: "oklch(0.55 0.26 350)",
      secondary: "oklch(0.55 0.15 210)",
      tertiary: "oklch(0.60 0.18 45)",
    },
    dark: {
      bg: "oklch(0.18 0.06 285)",
      fg: "oklch(0.96 0.02 320)",
      muted: "oklch(0.72 0.05 285)",
      primary: "oklch(0.70 0.27 350)",
      secondary: "oklch(0.82 0.16 200)",
      tertiary: "oklch(0.75 0.18 45)",
    },
    fonts: { display: "Chakra Petch", body: "Inter", mono: "JetBrains Mono" },
    signature:
      "perspective neon grid to a glowing sunset orb; event rockets across with neon trails",
    press: "gradient-lift",
    radius: "sharp",
  },
  {
    ...
    light: {
      ...
      primary: "oklch(0.55 0.21 28)",
      secondary: "oklch(0.42 0.10 250)",
      tertiary: "oklch(0.58 0.11 85)",
    },
    dark: {
      bg: "oklch(0.185 0.012 60)",
      fg: "oklch(0.95 0.01 85)",
      muted: "oklch(0.70 0.02 60)",
      primary: "oklch(0.68 0.19 28)",
      secondary: "oklch(0.72 0.12 250)",
      tertiary: "oklch(0.80 0.11 85)",
    },
    fonts: { display: "Fraunces", body: "Archivo", mono: "JetBrains Mono" },
    signature:
      "strict column rules, section numerals, hanging pull-quote, hairline contents-page index",
    press: "restrained",
    radius: "sharp",
  },
  {
    ...
    light: {
      ...
      fg: "oklch(0.15 0.01 250)",
      muted: "oklch(0.44 0.02 250)",
      primary: "oklch(0.53 0.18 45)",
      secondary: "oklch(0.50 0.15 240)",
      tertiary: "oklch(0.62 0.14 100)",
    },
    dark: {
      ...
      secondary: "oklch(0.66 0.22 35)",
      tertiary: "oklch(0.72 0.16 240)",
    },
  ...
  },
  {
    ...
    light: {
      ...
      fg: "oklch(0.26 0.03 120)",
      muted: "oklch(0.46 0.04 120)",
      primary: "oklch(0.52 0.12 150)",
      secondary: "oklch(0.53 0.14 45)",
      tertiary: "oklch(0.62 0.11 88)",
    },
    dark: {
      bg: "oklch(0.19 0.024 155)",
      fg: "oklch(0.94 0.02 90)",
      muted: "oklch(0.70 0.03 130)",
      primary: "oklch(0.72 0.13 148)",
      secondary: "oklch(0.72 0.14 60)",
      tertiary: "oklch(0.82 0.12 88)",
    },
  ...
  },
  {
    ...
    light: {
      ...
      fg: "oklch(0.20 0.03 220)",
      muted: "oklch(0.44 0.04 220)",
      primary: "oklch(0.55 0.26 350)",
      secondary: "oklch(0.52 0.13 200)",
      tertiary: "oklch(0.53 0.15 75)",
    },
    dark: {
      bg: "oklch(0.15 0.02 220)",
      fg: "oklch(0.92 0.03 195)",
      muted: "oklch(0.68 0.05 200)",
      primary: "oklch(0.68 0.27 350)",
      secondary: "oklch(0.85 0.15 195)",
      tertiary: "oklch(0.80 0.17 75)",
    },
    fonts: { display: "Chakra Petch", body: "Inter", mono: "JetBrains Mono" },
  ...
  },
  {
    ...
    light: {
      ...
      fg: "oklch(0.22 0.02 60)",
      muted: "oklch(0.44 0.03 60)",
      primary: "oklch(0.53 0.12 74)",
      secondary: "oklch(0.45 0.10 40)",
      tertiary: "oklch(0.42 0.13 20)",
    },
    dark: {
      bg: "oklch(0.16 0.008 60)",
      fg: "oklch(0.93 0.018 82)",
      muted: "oklch(0.68 0.03 70)",
      primary: "oklch(0.82 0.13 85)",
      secondary: "oklch(0.72 0.10 55)",
      tertiary: "oklch(0.62 0.15 22)",
    },
    fonts: { display: "Cormorant Garamond", body: "Jost", mono: "JetBrains Mono" },
    signature:
      "thin gold hairline system, gold-foil sheen on hover, gold-line constellation, deep space",
    press: "restrained",
    radius: "sharp",
  },
  {
    ...
    light: {
      bg: "oklch(0.97 0.012 285)",
      fg: "oklch(0.24 0.03 290)",
      muted: "oklch(0.48 0.04 290)",
      primary: "oklch(0.55 0.19 290)",
      secondary: "oklch(0.60 0.16 25)",
      tertiary: "oklch(0.58 0.13 165)",
    },
    dark: {
      bg: "oklch(0.22 0.035 290)",
      fg: "oklch(0.95 0.01 290)",
      muted: "oklch(0.72 0.03 290)",
      primary: "oklch(0.72 0.19 290)",
      secondary: "oklch(0.76 0.16 25)",
      tertiary: "oklch(0.82 0.12 165)",
    },
    fonts: { display: "Fredoka", body: "DM Sans", mono: "JetBrains Mono" },
    signature:
      "puffy clay shapes with dual soft shadows; event orb pops out to squishy platform coins",
    press: "gradient-lift",
    radius: "round",
  },
  {
    ...
    light: {
      ...
      fg: "oklch(0.26 0.04 268)",
      muted: "oklch(0.48 0.05 268)",
      primary: "oklch(0.52 0.16 275)",
      secondary: "oklch(0.53 0.13 220)",
      tertiary: "oklch(0.60 0.12 90)",
    },
    dark: {
      bg: "oklch(0.16 0.03 265)",
      fg: "oklch(0.95 0.012 250)",
      muted: "oklch(0.70 0.03 265)",
      primary: "oklch(0.72 0.14 275)",
      secondary: "oklch(0.85 0.12 200)",
      tertiary: "oklch(0.86 0.11 90)",
    },
    fonts: { display: "Space Grotesk", body: "Inter", mono: "JetBrains Mono" },
    signature:
      "animated starfield; event-star connects via drawn glowing edges to twinkling platform stars",
    press: "glow-inset",
    radius: "sharp",
  },
];
